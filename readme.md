# Driving Vehicle Models from Drone Perspective
Provide the trained model files (pt format

# Body

Driving Vehicle Models from Drone Perspective
Provided are trained models in .pt format, process files, and validation images. The dataset contains 18600 training images with clear pictures and comprehensive annotations suitable for drone aerial vehicle detection, traffic monitoring, intelligent recognition, etc. It is convenient and ready to use
